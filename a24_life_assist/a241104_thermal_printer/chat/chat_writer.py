...
content = '''
Quick todo，要求快记和“绝对优先”；文字直显思维；不记日期
---

把小电脑配置成 服务器主机 
这样我们就可以在其上部署 长期的 带模型推理的服务
然后跑label studio标注 最近摄像头拍下的图像数据

有时间探索怎么样把小电脑我 配置成既能播放 又能采集声音 的AI语音助手。直接放在床上，由他来 闹醒和提醒 吃药 等。

❗️填选课申请 去打印店打印
顺便网上随便找个日历模板 直接打印出来 后面再 按需剪出来 贴
