...
class Distributor:
    def __init__(self, filenames: dict, remote=('localhost', 8002)):
        self.tasks = []
        ...
        self.time_db_conn = sqlite3.connect(self.filenames['time_db'])
        self.users_db_conn = sqlite3.connect(self.filenames['users_db'])

    def mono_timetrack(self):
        mono = sum(self.users[self.current_user]['time_tracks'], start=TimeTrack())
        return mono

    def change_balance(self, purc_: bool, purc: bool, duration: timedelta):
